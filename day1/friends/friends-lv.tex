...
\begin{document}
    ...
    \begin{enumerate}
        \item Ja ievaddatos norādītā virkni $U$ nevarēja iegūt izmantojot iepriekš aprakstīto paņēmienu, tad Jūsu programmai jāizvada {\tt NOT POSSIBLE}.%If it is not possible that the final string is created using above
        %procedure, you should print {\tt NOT POSSIBLE}.
        \item Ja sākotnējā virkne $S$ nav viennozīmīgi nosakāma, tad Jūsu programmai jāizvada {\tt NOT UNIQUE}. %If the original string is not unique, you should print {\tt NOT UNIQUE}.
    \end{enumerate}
