...
\begin{document}
    ...
    Here is the input to the sample grader which represents three corners that
    ...
    Here is the input to the sample grader which matches the example given
    in the task statement above:
