...
\begin{document}
    ...
    \begin{description}
        ...
        \item[Subtask 2 (15 points):] $N \le 500$. The network of corners and alleys will form a grid-shaped structure. An example of such network is shown below. \\
           \begin{tikzpicture}
           	\draw (0,0) grid (3,2);
           	\foreach \x in {0,1,2,3} \foreach \y in {0,1,2}
           		\draw (\x,\y) node[circle,draw,fill=white] {};
           \end{tikzpicture}
