...
\begin{document}
    ...
    \constant{0} nolla tarkoittaa samaa kuin \constant{false} ja
    ...
    \begin{description}
        \item[Osatehtävä 1 (15 pistettä):] $2 \le N \le 500$.
        Jokaisen kahden kadunkulman välillä on tasan yksi polku.        
        \item[Osatehtävä 2 (15 pistettä):] $2 \le N \le 500$. Kadunkulmien ja
    ...
    Oikeanpuoleisin sarake määrittää rosvon alkukadunkulmat jokaiselle
    poliisin alkukadunkulmalle.
